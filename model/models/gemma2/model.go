...
func (sa *SelfAttention) Forward(ctx ml.Context, hiddenState, positionIDs ml.Tensor, cache kvcache.Cache, opts *Options) ml.Tensor {
	...
	q = fast.RoPE(ctx, q, positionIDs, uint32(opts.attnKeyLen), opts.ropeBase, opts.ropeScale, rope.WithTypeNeoX())
	...
	k = fast.RoPE(ctx, k, positionIDs, uint32(opts.attnKeyLen), opts.ropeBase, opts.ropeScale, rope.WithTypeNeoX())
...
func (m *Model) Shift(ctx ml.Context, layer int, key, shift ml.Tensor) (ml.Tensor, error) {
	return fast.RoPE(ctx, key, shift, uint32(m.Options.attnKeyLen), m.Options.ropeBase, m.Options.ropeScale, rope.WithTypeNeoX()), nil
}
